...
sns.heatmap(calendar.isnull(), cbar=False) # heatmap for missing values 
...
sns.heatmap(listings.isnull(), cbar=False) # heat map for missing values
...
sns.heatmap(reviews.isnull(), cbar=False) # heat map for missing values
